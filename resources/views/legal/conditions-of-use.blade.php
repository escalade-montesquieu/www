<x-app-layout>
    <section class="container lg:mt-40">
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Objet et définitions</h2>
            <p class="mb-2">
                Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de
                l’utilisation du site <b>escalade-montesquieu.fr</b> et de ses services.
            </p>
            <p class="mb-2">
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Mentions légales</h2>
            <p class="mb-2">
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Accès aux services</h2>
            <p class="mb-2">
            ...
            <p class="mb-2">
                Les services suivants ne sont accessible pour l’Utilisateur que s’il est <b>Membre</b> du site
                (c’est-à-dire qu’il s'est identifié à l’aide de ses identifiants de connexion):
            </p>
            <ul class="list-disc ml-5 space-y-2 mb-2">
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Responsabilité de l’Utilisateur</h2>
            <p class="mb-2">
            ...
            <p class="mb-2">
                L'Utilisateur s'engage à communiquer sa véritable identitée lors de son inscription, et à ne pas usurper
            ...
            <p class="mb-2">
                ...
                présents sur le site <b>escalade-montesquieu.fr</b>.
            </p>
            <p class="mb-2">
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Responsabilité de l’Éditeur</h2>
            <p class="mb-2">
            ...
            <p class="mb-2">
                Le site <b>escalade-montesquieu.fr</b> s'engage à mettre en œuvre tous les moyens nécessaires pour
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Propriété intellectuelle</h2>
            <p class="mb-2">
                Les contenus du site <b>escalade-montesquieu.fr</b> (logos, textes, éléments graphiques, vidéos, etc.)
            ...
            <p class="mb-2">
                ...
                porter atteinte à un tiers.<sub>©Montes</sub>
            </p>
            <p class="mb-2">
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Données personnelles</h2>
            <p class="mb-2">
                Voir aussi la
            ...
            <p class="mb-2">
                ...
                <br><b>escalade-montesquieu.fr</b> garanti le respect de la vie privée de l’utilisateur, conformément à
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Liens hypertextes</h2>
            <p class="mb-2">
                Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la
                responsabilité de l’Éditeur de <b>escalade-montesquieu.fr</b>, qui n’a pas le contrôle total sur ces
                liens.
            </p>
            <p class="mb-2">
                Il est possible pour un tiers de créer un lien vers une page du site <b>escalade-montesquieu.fr</b> sans
                autorisation expresse de l’éditeur.
            </p>
        </section>
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Évolution des conditions générales d’utilisation</h2>
            <p class="mb-2">
                Le site <b>escalade-montesquieu.fr</b> se réserve le droit de modifier les clauses de ces conditions
                d’utilisation à tout moment et sans justification.
            </p>
        </section>
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Durée du contrat</h2>
            <p class="mb-2">
        ...
        <section class="AboutLayout-section">
            <h2 class="text-h2 mt-12 mb-4">Droit applicable et juridiction compétente</h2>
            <p class="mb-2">
