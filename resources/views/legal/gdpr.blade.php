<x-app-layout>
    ...
    <section class="container lg:mt-40">
        ...
        <h2 class="text-h2 mt-12 mb-4">Responsables de la collecte des données personnelles</h2>
        <p class="mb-2">
        ...
        <h2 class="text-h2 mt-12 mb-4">Finalité des données collectées</h2>
        <p class="mb-2">
        ...
        escalade-montesquieu.fr ne commercialise pas vos données personnelles qui sont donc uniquement utilisées par
        nécessité ou à des fins statistiques et d’analyses.
        <p class="mb-2"></p>


        <h2 class="text-h2 mt-12 mb-4">Droit d’accès, de rectification et d’opposition</h2>
        <p class="mb-2">
        ...
        <ul class="list-disc ml-5 space-y-2 mb-2">
            ...
            <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui
                escalade-montesquieu.fr devra communiquer (ou non) ses données à un tiers qu’ils aura préalablement
                désigné
            </li>
        </ul>
        ...
        <pre class="mb-2">PROUST Arthaud – DPO,
proust@arthaud.dev .</pre>
        ...
        <h2 class="text-h2 mt-12 mb-4">Non-communication des données personnelles</h2>
        <p class="mb-2">
        ...
        <p class="mb-2">
            ...
            personnes non autorisées. <sub>©Montes</sub>
        ...
        <p class="mb-2">
            ...
            escalade-montesquieu.fr sont principalement les agents du service d’administration de escalade-montesquieu.
        </p>
        <h2 class="text-h2 mt-12 mb-4">Notification d’incident</h2>
        <p class="mb-2">
        ...
        <h2 class="text-h2 mt-12 mb-4">Sécurité</h2>
        <p class="mb-2">
            Pour assurer la sécurité et la confidentialité des Données Personnelles escalade-montesquieu.fr utilise
        ...
        <h2 class="text-h2 mt-12 mb-4">Droit applicable et attribution de juridiction.</h2>
        <p class="mb-2">
